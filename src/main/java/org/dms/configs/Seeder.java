...
public class Seeder {
    ...
    public void seedUsers() {
        ...
        personService.addPerson("Naruto", "naruto@uzumaki.com", "123123166", DEFAULT_PASSWORD, Role.STUDENT);
        personService.addPerson("Opu", "minato@namikaze.com", "123123166", DEFAULT_PASSWORD, Role.STUDENT);
